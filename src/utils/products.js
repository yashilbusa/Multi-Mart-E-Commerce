...
export const serviceData = [
  {
    ...
    title: "Free Shipping",
    subtitle: "We Give Free Shiping to The all Customer.",
    bg: "#fdefe6",
  },
  {
    icon: <ion-icon name="card"></ion-icon>,
    title: "Safe Payment",
    subtitle: "We Ensure that Customer do Safe Payment Without Any Hesitation.",
    bg: "#ceebe9",
  },
  {
    icon: <ion-icon name="shield-half-outline"></ion-icon>,
    title: "Secure Payment",
    subtitle: "We Check Payment Securely And not get any privacy policy.",
    bg: "#e2f2b2",
  },
  {
    icon: <ion-icon name="headset"></ion-icon>,
    title: " Back Guarantee",
    subtitle: "We ensure the Product has a more Reliablity.",
    bg: "#d6e5fb",
  },
];
...
export const discoutProducts = [
  {
    ...
    discount:30,
    shortDesc:
      "This is The Our Best Product",
    description:
      "This is The Our Best Product",
    reviews: [
      {
        rating: 4.7,
        text: "This is The Our Best Product",
      },
    ],
    avgRating: 4.5,
  },
